...
export default function Footer() {
  return (
    <footer className="flex w-full flex-col items-center overflow-x-auto bg-white px-20 pb-3.5 pt-11 max-md:px-5">
      <div className="flex max-w-[900px] flex-col">
          ...
          <div className="flex gap-5 max-md:flex-col">
            <div className="flex flex-col max-md:ml-0 max-md:w-full">
              <div className="grow max-md:mt-10 max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col">
                  <div className="flex min-w-[220px] flex-col max-md:ml-0 max-md:w-full">
                    <div className="flex w-full flex-col max-md:mt-10">
                      <div className="flex gap-5 whitespace-nowrap rounded-none text-4xl font-semibold tracking-wide text-violet-950 max-md:mr-1.5">
                        <img
                          loading="lazy"
                  ...
                  {footerColumns.map((column, index) => (
                    <div
                      key={column.title}
                      className="ml-5 flex w-3/12 flex-col max-md:ml-0 max-md:w-full"
                    >
                      <div className="mt-4 flex grow flex-col items-start rounded-none text-xl font-light text-violet-950 max-md:mt-10">
        ...
        <hr className="mt-14 h-px w-full shrink-0 max-md:mt-10" />
